	...
	public String evaluateGuess(String arg) {
		...
		case 1:
			if (shapeGuess.equals("Line")) {
				...
				productOfParams = parameters[0];
			}
			break; 
		case 2: 
			shapeGuessResult = classify2Parameters(parameters[0], parameters[1]);
			productOfParams = parameters[0] * parameters[1];
		...
		case 3:
			...
			productOfParams = parameters[0] * parameters[1] * parameters[2];
		...
		case 4:
			...
			productOfParams = parameters[0] * parameters[1] * parameters[2] * parameters[3];
		...
		System.out.println("product.."+ productOfParams);
